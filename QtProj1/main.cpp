...
int main(int argc, char *argv[])
{
    ...
    const QByteArray ref_hash_base64 = QByteArray("fHRe5jZUvHCkhD4U4UlA6JRM1m/ecDOLDHGgrCeGjMU=");
    ...
    if(result_checksum) {
        QMessageBox::critical(NULL,QObject::tr("Ошибка"),QObject::tr("Хэш-код не совпадает!!!"));
        return 0;
    }
