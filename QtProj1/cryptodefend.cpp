#include "cryptodefend.h""
#include <openssl/evp.h>

cryptodefend::cryptodefend(){
...
int cryptodefend::encryption(QString file) {

    unsigned char *key = (unsigned char *)"4ba29b9f9e5732ed33761840f4ba6c53";
    ...
    QFile decryptedFile;
    decryptedFile.setFileName("C:/Users/dns/Documents/QtProj1/open_credentials.json");
...
int cryptodefend::encrypt(unsigned char *text, int text_len, unsigned char *key, unsigned char *iv, unsigned char *ciphertext)
{
    EVP_CIPHER_CTX *ctx;
...
QString cryptodefend::decryption(QString file, unsigned char *key) {
    ...
    //Создание буфера из считанных байтов
...
int cryptodefend::decrypt(unsigned char *ciphertext, int ciphertext_len, unsigned char *key, unsigned char *iv, unsigned char *decryptext)
{
    EVP_CIPHER_CTX *ctx;
...
int cryptodefend::cryptoerror(void)
{
    return 1;
}
