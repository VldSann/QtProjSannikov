    ...
    ui(new Ui::list)
{
    ...
    QString file = "C:/Users/dns/Documents/QtProj1/credentials.json";

    cryptodefend test;

    //проверка зашифрованного файла и создание его
    ...
    QObject::connect(loginMapper,SIGNAL(mappedInt(int)),this,SLOT(copy_login(int)));
    QObject::connect(passwordMapper,SIGNAL(mappedInt(int)),this,SLOT(copy_pass(int)));
...
void list::on_find_textChanged(const QString &arg1)
{
